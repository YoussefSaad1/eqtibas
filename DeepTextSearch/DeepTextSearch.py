...
class TextEmbedder:
    def __init__(self, elasr_name=None):
        ...
        self.corpus_embeddings_data = os.path.join('embedding-data/',
                                                   f'corpus_embeddings_data_{self.elasr_name}.pickle')
        ...
        self.corpus_with_diacritics = os.path.join('embedding-data/',
                                                   f'corpus_with_diacritics_{self.elasr_name}.pickle')
