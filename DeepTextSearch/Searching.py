...
class SearchImage:
    def __init__(self):
        self.image_data = pd.read_pickle(f"/media/youssef/DVolume/AI/home/upwork/eqtibas/embedding-data/corpus_list_data.pickle")
    ...
    def search_by_vector(self, vector, n_out: int):
        ...
        index_s.load("/media/youssef/DVolume/AI/home/upwork/eqtibas/meta_data/text_features_index.ann")  # superfast, will just mmap the file
