...
class SearchImage:
    def __init__(self):
        self.image_data = pd.read_pickle(f"embedding-data/corpus_with_diacritics.pickle")
    ...
    def search_by_vector(self, vector, n_out: int):
        ...
        index_s.load("meta_data/text_features_index.ann")  # superfast, will just mmap the file
